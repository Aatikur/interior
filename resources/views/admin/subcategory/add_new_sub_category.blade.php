            ...
            <div class="x_panel">
                ...
                <div>
                    <div class="x_content">
                        ...
                        @else
                            {{ Form::open(['method' => 'post','route'=>'admin.add_sub_category','enctype'=>'multipart/form-data']) }}
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            @if (isset($sub_category))
                                {!! Form::select('category', $category, $sub_category->cat_id,['class' => 'form-control','placeholder'=>'Please Select Category']); !!}
                            @else
