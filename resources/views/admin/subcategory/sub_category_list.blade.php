                            ...
                            @endphp
                                @foreach ($sub_category as $item)
                                    <tr>
                                      ...
                                      <td><img src="{{asset('images/sub_category/thumb/'.$item->image.'')}}" height="100" /></td>
                                      <td>{{ $item->price}}</td>
                                      <td>
                                        @if ($item->status == '1')
                                      ...
                                      <td>
                                        <a href="{{route('admin.sub_category_edit_form',['id'=>encrypt($item->id)])}}" class="btn btn-sm btn-warning">Edit</a>
                                        @if ($item->status == '1')
